...
// void BufferManager::writeMatrixPage(string matrixName, int rowIndex, int blockIndex, vector<int> rows, int rowCount)
// {
//     logger.log("BufferManager::writePage");
//     Page page(matrixName, rowIndex, blockIndex, rows, rowCount);
//     page.writePage();
// }
...
void BufferManager::removeTablePagesFromPool(string tableName){
    Table* table = tableCatalogue.getTable(tableName);
    logger.log("BufferManager::removeTablePagesFromPool");
